...
/* Лоты */
INSERT INTO lots (name, cost, imgUrl, description, endTime, step, quantityBets, categoryId, authorId, winnerId, createdTime) 
VALUES ('2014 Rossignol District Snowboard', 10999, 'img/lot-1.jpg', 'Лучшая доска для сноуборда', '2017-09-21 12:00:00', 2000, 2, 2, 1, 2, '2017-09-02 15:42:01');
...
INSERT INTO lots (name, cost, imgUrl, description, endTime, step, quantityBets, categoryId, authorId, winnerId, createdTime) 
VALUES ('Крепления Union Contact Pro 2015 года размер L/XL', 8000, 'img/lot-3.jpg', 'Эти крепления обеспечат вашу безопасность всегда и везде', '2017-09-18 01:00:00', 1000, 5, 3, 1, 3, '2017-09-05 16:01:55');

INSERT INTO lots (name, cost, imgUrl, description, endTime, step, quantityBets, categoryId, authorId, winnerId, createdTime) 
VALUES ('Ботинки для сноуборда DC Mutiny Charocal', 10999, 'img/lot-4.jpg', 'Ботинки не только крепкие, но и теплые', '2017-09-16 13:30:00', 500, 2, 4, 2, 1, '2017-09-01 18:06:54');
