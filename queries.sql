...
INSERT INTO lots (name, cost, url, description, endTime, step, quantityBets, categoryId, authorId, winnerId, createdTime) VALUES
    ...
    ('Крепления Union Contact Pro 2015 года размер L/XL', 8000, 'img/lot-3.jpg', 'Эти крепления обеспечат вашу безопасность всегда и везде', '2017-10-18 01:00:00', 1000, 5, 3, 1, 3, '2017-09-05 16:01:55'),
    ('Ботинки для сноуборда DC Mutiny Charocal', 10999, 'img/lot-4.jpg', 'Ботинки не только крепкие, но и теплые', '2017-10-16 13:30:00', 500, 2, 4, 2, 1, '2017-09-01 18:06:54'),
